...
document.addEventListener("DOMContentLoaded", async function () {
    ...
    require(["vs/editor/editor.main"], function (ignorable) {
        ...
        layout.registerComponent('codeAssistant', function(container) {
            container.getElement().html(`
                <div class="chat-assistant-container">
                    <div id="chat-messages" class="chat-messages"></div>
                    <div class="chat-input-container">
                        <input id="chat-input" type="text" placeholder="Ask about the code..." />
                        <button id="chat-send" class="ui primary button">Send</button>
                    </div>
                </div>
            `);
        });
...
export function initialize() {
    ...
    layout = new GoldenLayout(config, document.getElementById("judge0-site-content"));
...
// Export the layout for other modules to use
export { layout };
